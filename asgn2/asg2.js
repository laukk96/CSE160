...
function main() {
    ...
    // Test draw for Triangle3D: Working
...
function renderAllShapes(){
    ...
    sendPerformanceStatsToHTML("selected type:" + g_selectedType + "numdot: " + len + " | ms: " + Math.floor(duration) + " | fps: " + Math.floor(10000/duration)/10, "numdot");
}
