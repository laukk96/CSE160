...
function connectVariablesToGLSL() {
  ...
  if (a_Normal < 0) {
    console.log("Failed to get the storage loc ation of a_Normal");
    return;
  }
...
function main() {
  ...
  // Camera: Set initial camera position
...
function drawSkyBox() {
  ...
  skybox.setTranslate(-skyboxScale / 2, -1, -skyboxScale / 2);
...
function drawGroundCube() {
  ...
  cubematrix.translate(-groundScale / 2, -1, -groundScale / 2);
  cubematrix.scale(groundScale, 0.1, groundScale);
